...
public class I18N {
	...
	private static String LANG_FILE = "/res/strings/ru.properties";
	
	static {
		try {
			InputStream is = Utils.getResourceFromJar(LANG_FILE);
			//InputStream is = new FileInputStream(Utils.getRootPath() + LANG_FILE)
		    properties = loadProperties(is, "utf-8");
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
